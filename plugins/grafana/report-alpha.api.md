...
// @alpha
const grafanaPlugin: OverridableFrontendPlugin<
  {
  ...
  {},
  {
    ...
    'entity-content:grafana/alerts': OverridableExtensionDefinition<{
      kind: 'entity-content';
      name: 'alerts';
      config: {
    ...
    'entity-content:grafana/dashboards': OverridableExtensionDefinition<{
      kind: 'entity-content';
      name: 'dashboards';
      config: {
        path: string | undefined;
    ...
    'page:grafana': OverridableExtensionDefinition<{
      kind: 'page';
      name: undefined;
      config: {
        path: string | undefined;
